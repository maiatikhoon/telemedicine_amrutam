...
module.exports.bookConsultation = asyncErrorHandler(async (req, res) => {
    ...
    await AuditService.logAction({ userId: req.user.id, action: "consultation_booked", metadata: { slotId: consultation.slot_id, consultationId: consultation.id } })
...
module.exports.completeConsultation = asyncErrorHandler(async (req, res) => {
    ...
    await AuditService.logAction({ userId: req.user.id, action: "consultation_completed", metadata: { consultationId: id, status: _consultationStatus.completed } })
